...
contains
   ...
   subroutine OUT_init()
      ...
      OUT_head_density = CFG_get_real("output_head_density")
      OUT_num_bins = CFG_get_int("output_num_bins")
      OUT_num_fields = CFG_get_size("output_eedf_min_max_fields") / 2
      allocate(OUT_eedf_min_max_fields(2 * OUT_num_fields))
      call CFG_get("output_eedf_min_max_fields", OUT_eedf_min_max_fields)
      call CFG_get("output_eedf_eV_range", OUT_eedf_eV_range)
   end subroutine OUT_init

   subroutine OUT_write_vars(sim_name, sim_type, cntr, time)
      ...
      case (MODEL_part)
         ...
         call PM_get_output(pos_data, sca_data, data_names, n_pos, n_sca, time, OUT_head_density)
   ...
   subroutine OUT_write_coeffs(sim_name, sim_type)
      ...
      use m_particle_1d, only: PC_get_coeffs
